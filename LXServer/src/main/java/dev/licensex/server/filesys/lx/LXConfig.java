...
public class LXConfig extends LicenseXFile {
    ...
    public LXConfig(String path, List<String> content) throws LXServerException {
        super(FilenameUtils.getName(path), FilenameUtils.getPath(path), content);
    }

    public LXConfig(String path, List<String> content, boolean encrypt) throws LXServerException {
